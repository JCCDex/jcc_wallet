  ...
  describe("test plugin hash&sign&verify&recover", function() {
    it("test swtc hash & sign & verify & reocover", function() {
      ...
      expect(signed).to.equal(
        "304402203334B198BBD525A25797AA352A028ED87425F21FE4F1DEED9EEBBB5DD14AE13E02204FD908322CFB48008AE51137BA0BC1B8D6B84EDF161DF0D4DF9DB36A041FC5F7"
      );
    ...
    it("test xrp hash & sign & verify & reocover", function() {
      ...
      expect(signed).to.equal(
        "304402206D79F6C7F3F39CCF9BC6EA046162EE8466A0457C56F814D61A182EAB1377265C0220623B0F4368EF32A07237800331FA89D96465ED9901D0D03462DC7244C0219DD9"
      );
